...
$bgcolor = "#FFFFFF";			# 背景色
$text    = "#333333";			# 文字色を指定
$link    = "#990000";			# リンク色を指定（未リンク）
$vlink   = "#660000";			# リンク色を指定（既リンク）
$alink   = "#CC6699";			# リンク色を指定（リンク中）
...
# CGIスクリプト自身をURLで指定
$script  = "http://waiwai.ciao.jp/waiwai/sunbbs/test/sunbbs.cgi";

# 表示ファイル (index.html) のある「ディレクトリ」をURLで指定
$htm_url = "http://waiwai.ciao.jp/waiwai/sunbbs/test";

## --- 応用設定
$whatsnew = 1;				# 新着情報ボードモード (0=no 1=yes)
$obi_color = "#FFCCCC";			# 題名部の色
$point  = '■';				# 題名部ポインタ
$point2 = '▲';				# 戻り先部ポインタ
