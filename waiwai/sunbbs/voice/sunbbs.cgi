...
$bgcolor = "#FFFFCC";			# 背景色
$text    = "#996600";			# 文字色を指定
$link    = "#CC9900";			# リンク色を指定（未リンク）
$vlink   = "#996600";			# リンク色を指定（既リンク）
$alink   = "#FFFF00";			# リンク色を指定（リンク中）

$pass = '3064';				# 管理用パスワード(英数字)
...
# CGIスクリプト自身をURLで指定
$script  = "http://waiwai.ciao.jp/waiwai/sunbbs/voice/sunbbs.cgi";

# 表示ファイル (index.html) のある「ディレクトリ」をURLで指定
$htm_url = "http://waiwai.ciao.jp/waiwai/sunbbs/voice";

## --- 応用設定
$whatsnew = 1;				# 新着情報ボードモード (0=no 1=yes)
$obi_color = "#FFCC66";			# 題名部の色
$point  = '■';				# 題名部ポインタ
$point2 = '▲';				# 戻り先部ポインタ
$p_color = "#FF9900";			# ポインタの色
$s_color = "#FFFFFF";			# 題名の色
