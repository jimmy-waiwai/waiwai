...
$bgcolor = "#FFF0F5";			# 背景色
$text    = "#996666";			# 文字色を指定
$link    = "#CC9999";			# リンク色を指定（未リンク）
$vlink   = "#663333";			# リンク色を指定（既リンク）
$alink   = "#FF99FF";			# リンク色を指定（リンク中）

$pass = '5317';				# 管理用パスワード(英数字)
...
# CGIスクリプト自身をURLで指定
$script  = "http://waiwai.ciao.jp/waiwai/sunbbs/sonota/sunbbs.cgi";

# 表示ファイル (index.html) のある「ディレクトリ」をURLで指定
$htm_url = "http://waiwai.ciao.jp/waiwai/sunbbs/sonota";

## --- 応用設定
$whatsnew = 1;				# 新着情報ボードモード (0=no 1=yes)
$obi_color = "#FFC0CB";			# 題名部の色
$point  = '■';				# 題名部ポインタ
$point2 = '▲';				# 戻り先部ポインタ
$p_color = "#CC6699";			# ポインタの色
$s_color = "#FFFFFF";			# 題名の色
