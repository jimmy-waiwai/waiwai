...
$title   = "愛するには短すぎる／ネオ・ダンディズム！";			# タイトル名
$t_color = "#CC0033";			# タイトルの色
$t_size  = 4;				# タイトルのサイズ
...
$bgcolor = "#330033";			# 背景色
$text    = "#FFFFFF";			# 文字色を指定
$link    = "#CCCCCC";			# リンク色を指定（未リンク）
$vlink   = "#999999";			# リンク色を指定（既リンク）
$alink   = "#999966";			# リンク色を指定（リンク中）

$pass = '3482';				# 管理用パスワード(英数字)
...
# CGIスクリプト自身をURLで指定
$script  = "http://waiwai.ciao.jp/waiwai/sunbbs/aisuruni/sunbbs.cgi";

# 表示ファイル (index.html) のある「ディレクトリ」をURLで指定
$htm_url = "http://waiwai.ciao.jp/waiwai/sunbbs/aisuruni";

## --- 応用設定
$whatsnew = 1;				# 新着情報ボードモード (0=no 1=yes)
$obi_color = "#FFFFFF";			# 題名部の色
$point  = '■';				# 題名部ポインタ
$point2 = '▲';				# 戻り先部ポインタ
$p_color = "#CC0033";			# ポインタの色
$s_color = "#000000";			# 題名の色
...
$message = <<"MSG";
星組／宝塚大劇場2006年8/11～9/18・東京宝塚劇場10/6～11/12
MSG
