...
$title   = "MIND TRAVELLER";			# タイトル名
$t_color = "#FFFFFF";			# タイトルの色
$t_size  = 5;				# タイトルのサイズ
...
# CGIスクリプト自身をURLで指定
$script  = "http://waiwai.ciao.jp/waiwai/sunbbs/mindtrave/sunbbs.cgi";

# 表示ファイル (index.html) のある「ディレクトリ」をURLで指定
$htm_url = "http://waiwai.ciao.jp/waiwai/sunbbs/mindtrave";

## --- 応用設定
$whatsnew = 1;				# 新着情報ボードモード (0=no 1=yes)
$obi_color = "#000000";			# 題名部の色
$point  = '■';				# 題名部ポインタ
$point2 = '▲';				# 戻り先部ポインタ
$p_color = "#66FFFF";			# ポインタの色
$s_color = "#FFFFFF";			# 題名の色
...
$message = <<"MSG";
花組／ドラマシティ2006年11/10～22・日本青年館2006年11/30～12/6
MSG
