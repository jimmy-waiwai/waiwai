...
$bgcolor = "#99CCFF";			# 背景色
$text    = "#003366";			# 文字色を指定
$link    = "#336699";			# リンク色を指定（未リンク）
$vlink   = "#000066";			# リンク色を指定（既リンク）
$alink   = "#33FFFF";			# リンク色を指定（リンク中）

$pass = '6093';				# 管理用パスワード(英数字)
$home = "http://waiwai.ciao.jp/waiwai/index.shtml";		# 戻り先 (index.htmlなど)
$max  = 40;				# 記事の最大保持数
$pagelog  = 20;				# 表示ファイル第1ページの記事数
$autolink = 1;				# 自動リンク (0=no 1=yes)
$log_dir = ".";				# ログディレクトリ (フルパスだと / から)
$htm_dir = ".";				# 表示ファイルディレクトリ (フルパスだと / から)

# CGIスクリプト自身をURLで指定
$script  = "http://waiwai.ciao.jp/waiwai/sunbbs/seito/sunbbs.cgi";

# 表示ファイル (index.html) のある「ディレクトリ」をURLで指定
$htm_url = "http://waiwai.ciao.jp/waiwai/sunbbs/seito";

## --- 応用設定
$whatsnew = 1;				# 新着情報ボードモード (0=no 1=yes)
$obi_color = "#6699CC";			# 題名部の色
$point  = '■';				# 題名部ポインタ
$point2 = '▲';				# 戻り先部ポインタ
$p_color = "#3399FF";			# ポインタの色
$s_color = "#FFFFFF";			# 題名の色
...
$message = <<"MSG";
お約束として、一投稿につき、一人の人の事だけを書くこと。3行でもOK！
4月は花組、5月は月組、6月は雪組、7月は星組、8月は宙組、9月は専科、
10月は花組、11月は月組、12月は雪組、1月は星組、2月は宙組、3月は専科が一応のテーマです。
MSG
