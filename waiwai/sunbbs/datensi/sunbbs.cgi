...
$title   = "堕天使の涙／タランテラ！";			# タイトル名
$t_color = "#333333";			# タイトルの色
$t_size  = 4;				# タイトルのサイズ
...
$bgcolor = "#CC3333";			# 背景色
$text    = "#FFFFFF";			# 文字色を指定
$link    = "#999999";			# リンク色を指定（未リンク）
$vlink   = "#666666";			# リンク色を指定（既リンク）
$alink   = "#FF0066";			# リンク色を指定（リンク中）

$pass = '5128';				# 管理用パスワード(英数字)
...
# CGIスクリプト自身をURLで指定
$script  = "http://waiwai.ciao.jp/waiwai/sunbbs/datensi/sunbbs.cgi";

# 表示ファイル (index.html) のある「ディレクトリ」をURLで指定
$htm_url = "http://waiwai.ciao.jp/waiwai/sunbbs/datensi";

## --- 応用設定
$whatsnew = 1;				# 新着情報ボードモード (0=no 1=yes)
$obi_color = "#333333";			# 題名部の色
$point  = '■';				# 題名部ポインタ
$point2 = '▲';				# 戻り先部ポインタ
$p_color = "#990033";			# ポインタの色
$s_color = "#CCCCCC";			# 題名の色
